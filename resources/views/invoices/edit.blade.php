...
<div class="max-w-6xl mx-auto py-6">
    ...
    <form action="{{ route('invoices.update', $invoice) }}" method="POST" class="bg-white shadow-md rounded-lg p-8">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input type="number" name="invoice_net" id="invoice_net" value="{{ old('invoice_net', $invoice->invoice_net) }}" step="0.01" min="0"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-4"
                required>
        ...
        <div>
            ...
            <input type="number" name="invoice_vat" id="invoice_vat" value="{{ old('invoice_vat', $invoice->invoice_vat) }}" step="0.01" min="0"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-4"
                required>
        ...
        <div>
            ...
            <input type="number" name="invoice_total" id="invoice_total" value="{{ old('invoice_total', $invoice->invoice_total) }}" step="0.01" min="0"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-4"
                required>
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="extra_info" id="extra_info"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-4"
                rows="3">{{ old('extra_info', $invoice->extra_info) }}</textarea>
        ...
        <div class="md:col-span-2">
            ...
            <div class="border rounded-md p-4 max-h-64 overflow-y-auto">
                @php
                    $selectedJobs = old('translation_jobs', $invoice->translationJobs->pluck('id')->toArray());
                @endphp
    ...
    <div class="flex justify-end mt-6">
        ...
        <button type="submit" class="bg-[#702963] text-white px-6 py-2 rounded hover:bg-[#5a1f4f]">Update Invoice</button>
    </div>

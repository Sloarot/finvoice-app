...
<div class="max-w-4xl mx-auto py-6">
    ...
    <form action="{{ route('clients.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-8">
    @csrf
    ...
    <div class="flex justify-end mt-6">
        <button type="submit" class="bg-[#702963] text-white px-6 py-2 rounded hover:bg-[#5a1f4f]">Create Client</button>
    </div>
